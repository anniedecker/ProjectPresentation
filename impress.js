 ...
 * Used by Annie Decker, Paula Tran, and Maia Stokes for MIS 3033 project.
...
(function (document, window) {
    ...
    var select = function (el) {
        ...
        // make the page scroll back to the top whenever slide is selected
       ...
       window.scrollTo(0, 0);
        ...
        css(impress, {
            ...
            // to keep the perspective look similar for different scales, need to 'scale' the perspective
